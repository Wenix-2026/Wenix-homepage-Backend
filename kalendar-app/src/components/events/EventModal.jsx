...
// Opačný směr — DB sloupec reminder_minutes (integer) -> text pro <select>.
// Bez tohoto mapování se select po znovuotevření editace vždy resetoval
// na výchozí "1 den před", protože initialData.reminder v DB neexistuje
// (sloupec se jmenuje reminder_minutes, ne reminder).
